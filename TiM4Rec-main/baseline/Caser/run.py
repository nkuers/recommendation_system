...
if __name__ == '__main__':
    config = Config(model=Caser, config_file_list=['config.yaml'])
    ...
    model = Caser(config, train_data.dataset)
    ...
    trainer.resume_checkpoint('saved/Caser-Sep-22-2024_00-00-09.pth')
    # model training
