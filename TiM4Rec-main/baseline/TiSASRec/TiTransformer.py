...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, input_tensor, attention_mask, time_key, time_value):
        ...
        # [batch, seq_len, seq_len, num_heads, hidden_size] -> [batch, num_heads, seq_len, seq_len, hidden_dim]
